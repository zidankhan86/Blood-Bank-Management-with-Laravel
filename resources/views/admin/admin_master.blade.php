...
<head>
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="{{ URL::asset('../backend/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
    <!-- Daterange picker -->
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet"
        href="{{ URL::asset('../backend/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
    <!-- Toastr -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        function confirmDelete(slug, url) {
            swal({
                    title: "Are you sure?",
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        document.getElementById(`delete-class-form-${slug}`).action = url;
                        document.getElementById(`delete-class-form-${slug}`).submit();
                    }
                });
        }
    </script>
